...
fn main() -> Result<(), Box<dyn std::error::Error>>{
    ...
    */
    ...
    println!("(Obfuscated) {} op.: between {} and {}. True counter = {}, false counter = {}",opr_str,m1,m2,true_counter,false_counter);
    println!("Average time of an obfuscated gate: {:?}",time_accumulator/trials);
